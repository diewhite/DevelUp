...
public class DealRequestDTO {
	...
	public DealRequestDTO(String seller_id, String buyer_id, String req_id, Date req_time, int deal_number) {
		super();
	...
	public String toString() {
		return "DealRequestDTO [seller_id=" + seller_id + ", buyer_id=" + buyer_id + ", req_id=" + req_id
				+ ", req_time=" + req_time + ", deal_number=" + deal_number + "]";
	}
