...
<div id="contents">
    ...
    <form id="saveForm" name="saveForm">
      ...
      <input type="hidden" id="ENPR_SEQ" name="ENPR_SEQ">
          ...
          <div class="grid-item colspan2">
            ...
            <div class="tbl-basic-td">
              <div class="input-wrap w30" id="select_target_1">
                <select class="form-select grid-input" id="ENPR_SHPE_CD" name="ENPR_SHPE_CD" title="기업형태">
          ...
          <div class="grid-item colspan2">
            ...
            <div class="tbl-basic-td">
              <div class="input-wrap w100">
                <input class="grid-input" type="text" role="textbox" id="HOFS_DTADR" name="HOFS_DTADR" maxlength="50" title="본사 상세주소 입력">
              </div>
            </div>
          </div>
