...
<script type="text/javascript" src="/ongo/common/js/paginate.js"></script>
    <link rel="stylesheet" href="/ongo/common/css/paginate.css"> 
...
<script type="text/javascript">
	...
	$(document).ready(
			function() {
				...
				$("#dealType").change(
						function() {
							location.href = "/ongo/deal_listAll2.do?dealType="
									+ encodeURI($(this).val());
						})
			})
</script>
				...
				.ready(
						function() {
							...
							$("#category")
									.change(
											function() {
												location.href = "/ongo/deal_listAll2.do?category="
														+ encodeURI($(this)
																.val());
											})
